...
public class Util {
	...
	// *******************
	// 본인이 필요한 의존객체(Scanner)를 직접 생성(Scanner scan = new Scanner(System.in)) 하지 않고,
	// 외부로부터 전달받아서 사용하는 형태
	// 	-> 의존 객체를 주입받았다. (**********) 
	...
	public String getName() {
		...
		// DI 디자인 패턴
		// 	- 의존 객체를 생성하는 주제를 본인이 아니라 외부로 맡기는 패턴
		
		// Scanner scan = new Scanner(System.in); // 의존 객체를 직접 만드는 코드가 사라짐....(****)
